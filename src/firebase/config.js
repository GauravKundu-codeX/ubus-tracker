...
// This line reads the variable we will set in Netlify.
// It will be 'undefined' on your local PC, so it falls back to an empty object.
const configString = import.meta.env.VITE_FIREBASE_CONFIG;

if (!configString) {
  console.error("Firebase config is missing. Did you set it in Netlify or your .env file?");
